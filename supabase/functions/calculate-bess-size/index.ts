...
function calculateBessSize(
  ...
  const { final_power_kw, final_energy_kwh } = applyBufferAndMinimumSizes(
    required_power_kw,
    required_energy_kwh,
...
function calculatePeakShavingConfig(
  tariff_structure?: TariffStructure,
  sizing_params?: SizingParams,
  load_profile?: number[]
): PeakShavingConfig {
...
function calculateBackupRequirements(
  sizing_params?: SizingParams,
...
function calculatePeakShavingSizing(
  load_profile: number[],
  sizing_params?: SizingParams,
...
function calculateArbitrageRequirements(
  load_profile: number[],
  pv_profile?: number[],
  sizing_params?: SizingParams,
  peakShavingConfig?: PeakShavingConfig,
...
function calculatePvArbitrageContribution(
  load_profile: number[],
  pv_profile: number[],
...
// Apply buffer factor and ensure minimum sizes
function applyBufferAndMinimumSizes(
